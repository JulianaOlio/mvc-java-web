...
public class CadastroUsuarioController extends HttpServlet {
				...
				if (acao != null && acao.equals("update")) {
					...
					botaoForm = "Atualizar"; 
					 ...
					 for (Usuario usuario : usuarios) {
						...
						linhasDaTabela.append("    <td>\r\n");
						linhasDaTabela.append("        <a href=\"cadastroUsuario?action=delete&nome=" + usuario.getUsuario() + "\" class=\"btn-deletar\">Deletar</a>\r\n");
						linhasDaTabela.append("    </td>\r\n");
						linhasDaTabela.append("</tr>\r\n");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action != null && action.equals("delete")) {
			...
			response.sendRedirect(request.getContextPath() + "/cadsatroUsuario");
		}
